...
namespace Test
{
    [TestFixture("../../models/x/anim_test.x")]
    [TestFixture("../../models/x/BCN_Epileptic.x")]
    [TestFixture("../../models/x/fromtruespace_bin32.x")]
    [TestFixture("../../models/x/kwxport_test_cubewithvcolors.x")]
    [TestFixture("../../models/x/test.x")]
    [TestFixture("../../models/x/test_cube_binary.x")]
    [TestFixture("../../models/x/test_cube_compressed.x")]
    [TestFixture("../../models/x/test_cube_text.x")]
    [TestFixture("../../models/x/Testwuson.x")]
    [TestFixture("../../models-nonbsd/x/dwarf.x")]
    [Category("XFile")]
    public class XFileTest
    {
        public XFileTest(string filename)
        {
        ...
        void TestMesh(Assimp.Mesh netMesh, AssimpSharp.Mesh sharpMesh)
        {
            ...
            for (int i = 0; i < netMesh.VertexColorChannelCount; i++)
            {
                ...
                {
                    MathAssert.AreEqual(netMesh.VertexColorChannels[i], sharpMesh.Colors[i]);
                }
            }
            // MaterialIndex
        ...
        public void TestEachNode(Assimp.Node netNode, AssimpSharp.Node sharpNode)
        {
            ...
            Assert.AreEqual(netNode.HasMeshes, sharpNode.Meshes.Count > 0);
            ...
            Assert.AreEqual(netNode.HasChildren, sharpNode.Children.Count > 0);
        ...
        public void TestMaterials()
        {
            ...
            for(int materialIndex = 0; materialIndex < netMaterials.Count; materialIndex++)
            {
                ...
                {
                    MathAssert.AreNearEqual(netMaterial.Opacity, sharpMaterial.Opacity.Value);
                ...
                {
                    MathAssert.AreNearEqual(netMaterial.Reflectivity, sharpMaterial.Reflectivity.Value);
                ...
                {
                    MathAssert.AreNearEqual(netMaterial.Shininess, sharpMaterial.Shininess.Value);
                ...
                {
                    MathAssert.AreNearEqual(netMaterial.ShininessStrength, sharpMaterial.ShininessStrength.Value);
                ...
                {
                    Assert.AreEqual(netMaterial.ShadingMode.ToString(), sharpMaterial.ShadingMode.Value.ToString());
        ...
        public void TestAnimation()
        {
            ...
            Assert.AreEqual(assimpNetScene.HasAnimations, assimpSharpScene.Animations != null && assimpSharpScene.Animations.Count > 0);
